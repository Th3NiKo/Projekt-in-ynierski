...
public class MeteorSpawner : MonoBehaviour {
	...
	void Update () {
		...
		if(timer >= timeSpawn){
			...
			GameObject meter = Instantiate(meteors[randomMeteor],new Vector3(Random.Range(this.transform.position.x, 9.0f), Random.Range(4.0f, 15.0f), this.transform.position.z), obrot);
